...
<div class="navbar">
    ...
    <!-- Add export error alert after pagination -->
    <?php if(isset($_SESSION['export_error'])): ?>
    <div class="alert alert-error" style="background-color: #f2dede; color: #b94a48; border-color: #eed3d7; border-radius: 4px; border-left: 5px solid #b94a48; margin-bottom: 15px;">
...
<?php $voter_query=mysqli_query($conn,"SELECT v.*, d.department_name 
                                FROM voters v 
                                LEFT JOIN departments d ON v.department_id = d.department_id 
                                WHERE v.status='UnVoted'");
