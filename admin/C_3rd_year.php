...
<div class="navbar">
    ...
    <div class="position-tabs">
        ...
        <a class="active" href="C_3rd_year.php">3rd Year Representative</a>
...
<?php $candidate_query=mysqli_query($conn,"select c.*, d.department_name from candidate c LEFT JOIN departments d ON c.department_id = d.department_id where c.Position='3rd Year Representative'");
