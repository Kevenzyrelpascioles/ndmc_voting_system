...
<div class="navbar">
   ...
   <select name="rposition" class="rposition" id="span22">
    ...
    <div class="controls">
      <select name="department" id="department" class="department span2" required>
        ...
        <?php
          ...
          while($dept_row = mysqli_fetch_array($dept_query)) {
            // Pre-select current department if filtering is active
            $selected = "";
            if(isset($_SESSION['current_department']) && $_SESSION['current_department'] == $dept_row['department_id']) {
              $selected = "selected";
            }
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select name="course" id="course" class="course span2" required>
