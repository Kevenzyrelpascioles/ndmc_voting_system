...
<head>
    ...
    <title>Admin Login - NDMC Voting System</title>
    ...
    <style>
        /* Admin login styling */
        body {
            background-image: url('images/NdmcBuilding.jpg');
...
<?php include('enhanced_logger.php'); ?>
            ...
            <div class="error">
                ...
                if (isset($_POST['Login'])) {
                    ...
                    if ($login_query && mysqli_num_rows($login_query) > 0) {
                        ...
                        // Use enhanced logging for admin login
                        try {
                            logAdminAction($conn, 'Admin Login', "$f $l", 'authentication', $row['User_id']);
                            _redirect('home.php');
                        } catch (Exception $e) {
