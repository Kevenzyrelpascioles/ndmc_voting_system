...
<div class="navbar">
	...
	<input type="hidden" name="position" value="1st Year Representative">
...
<?php $candidate_query=mysqli_query($conn,"select c.*, d.department_name from candidate c LEFT JOIN departments d ON c.department_id = d.department_id where c.Position='1st Year Representative' $dept_filter");
