...
<div class="navbar">
    ...
    <div class="position-tabs">
        ...
        <a class="active" href="C_1st_year.php">1st Year Representative</a>
...
<?php $candidate_query=mysqli_query($conn,"SELECT c.*, d.department_name 
                                   FROM candidate c 
                                   LEFT JOIN departments d ON c.department_id = d.department_id 
                                   WHERE c.Position='1st Year Representative'");
