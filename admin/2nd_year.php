...
<div class="navbar">
	...
	<input type="hidden" name="position" value="2nd Year Representative">
...
<?php $candidate_query=mysqli_query($conn,"select c.*, d.department_name from candidate c LEFT JOIN departments d ON c.department_id = d.department_id where c.Position='2nd Year Representative' $dept_filter");
