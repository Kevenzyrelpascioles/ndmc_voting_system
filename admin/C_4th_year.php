...
<div class="navbar">
    ...
    <div class="position-tabs">
        ...
        <a class="active" href="C_4th_year.php">4th Year Representative</a>
    </div>
...
<?php $candidate_query=mysqli_query($conn,"select c.*, d.department_name from candidate c LEFT JOIN departments d ON c.department_id = d.department_id where c.Position='4th Year Representative'");
