...
if (!isset($_SESSION['temp_governor']) || !isset($_SESSION['temp_vice']) || !isset($_SESSION['temp_representative'])) {
...
$representative_id = $_SESSION['temp_representative'];
...
$representative_query = mysqli_query($conn, "SELECT * FROM candidate WHERE CandidateID='$representative_id'") or die(mysqli_error($conn));
$representative_data = mysqli_fetch_array($representative_query);
...
if (isset($_POST['finalize_vote'])) {
    ...
    mysqli_query($conn, "INSERT INTO votes (CandidateID, $voter_id_field) VALUES ('$representative_id', '$voter_id')") or die(mysqli_error($conn));
    ...
    unset($_SESSION['temp_representative']);
...
<body>
    ...
    <div class="container">
        <div class="confirmation-container">
            ...
            <div class="candidate-card">
                <div class="position-title">
                    <i class="bi bi-person-badge me-2"></i>1st Year Representative
                </div>
                <div class="candidate-info">
                    <img src="admin/<?php echo $representative_data['Photo']; ?>" alt="Representative Photo" class="candidate-photo">
                    <div>
                        <div class="candidate-name"><?php echo $representative_data['FirstName'] . ' ' . $representative_data['LastName']; ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                <a href="voting.php" class="btn btn-change">
