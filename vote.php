...
// Check if we have data from voting.php in session
...
elseif (isset($_POST['save'])){
    ...
    if ($representative == '--Select Candidate--') {
        echo "<script>alert('Please select a representative.'); window.location='voting.php';</script>";
        exit();
    }
...
<body>
    ...
    <div class="wrapper">
        ...
        <form method="POST">
            ...
            // Get governor details
            $name = '';
            if (!empty($governor) && $governor != '--Select Candidate--') {
            ...
            // Get vice-governor details
            $name1 = '';
            if (!empty($vice1) && $vice1 != '--Select Candidate--') {
