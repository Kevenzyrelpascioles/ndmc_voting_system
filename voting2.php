    ...
    <div class="container" style="margin-top: 100px;">
        ...
        echo '<div class="alert alert-info mb-3">
            <div class="row">
                ...
                <div class="col-sm-6"><strong>Year Level:</strong> 2nd Year</div>
            </div>
        </div>';
        ?>
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            <h2 class="mb-2 mb-md-0 fw-bold">Please Vote Wisely</h2>
            <a class="btn btn-info" id="help" href="help2.php">
        ...
        <form method="post" action="voting2.php">
            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header bg-success text-white" style="background: linear-gradient(90deg, #2e7d32, #4caf50) !important;">
                    <h4 class="m-0">Candidate for 2nd Year Representative</h4>
                </div>
                <div class="card-body">
                    <div class="candidates-grid row g-3 mb-3">
                        <?php 
                        $representative_query=mysqli_query($conn,"SELECT * FROM candidate WHERE Position='2nd Year Representative' AND course_id='$voter_course'") or die(mysqli_error($conn));
